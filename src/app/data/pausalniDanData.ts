...
export const courseLineUp = [
  `Online kurz bude veden formou <strong>videozáznamů</strong>, ke kterým ode mě po ukončení předprodeje (16.12.) <strong>získáte přístup</strong>. Videa budou strukturována tak, <strong>abyste se k jednotlivým tématům mohli kdykoli vrátit</strong>,`,
  `proto bude každému dílčímu tématu věnováno vždy <strong>samostatné video</strong>. Abyste ušetřili ještě více času, budete mít možnost zvolit i <strong>rychlost přehrávání podle potřeby</strong>.`,
];

export const answears = [
  `Internet je nesmírně bohatý zdroj informací, ale <strong>hledání v něm může být matoucí a časově náročné</strong>. V článcích můžete nakonec <strong>strávit hodiny a hrozí, že získáte nesprávné nebo neaktuální informace</strong>, což může mít negativní důsledky ve vztahu k finančnímu úřadu.`,
  `Z vlastní zkušenosti vím, že <strong>úředníci velmi často odmítají poskytovat rady</strong> a odkazují na účetní, případně Vám <strong>podají velmi stručné informace</strong>, na základě kterých nebudete schopni zvážit vše potřebné.`,
];
